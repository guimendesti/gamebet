...
<a href="<?php echo $baseUrlAdmin . "/saques/criar"; ?>" class="btn btn-success" style="float:right;">Novo Saque</a>
        ...
        array(
            ...
            'buttons' => array
                ...
                'update' => array
                    ...
                    'url' => '"' . $baseUrlAdmin . '/saques/editar/id/".$data->idjogsaque',
                ...
                'delete' => array
                    ...
                    'url' => '"' . $baseUrlAdmin . '/saques/deletar/id/".$data->idjogsaque',
                ),
            ),
