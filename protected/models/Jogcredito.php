...
/**
 * This is the model class for table "jogcredito".
 *
 * The followings are the available columns in table 'jogcredito':
 * @property integer $idjogcredito
 ...
 */
class Jogcredito extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('forma', 'length', 'max' => 9),
            array('data', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('idjogcredito, idjogador, data, valor, forma, situacao', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('idjogcredito', $this->idjogcredito);
     ...
     * @return Jogcredito the static model class
     */
